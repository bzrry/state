...
def run_tx_train(cfg: DictConfig):
    ...
    print(f"****** pin_memory: {trainer_kwargs["pin_memory"]}")
    print(f"****** persistent_workers: {trainer_kwargs["persistent_workers"]}")
    print(f"****** prefetch_factor: {trainer_kwargs["prefetch_factor"]}")
